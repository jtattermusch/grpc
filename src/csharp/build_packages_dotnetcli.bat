...
xcopy /Y /I /S ..\..\platform=windows\artifacts\csharp_ext_* nativelibs\
xcopy /Y /I /S ..\..\platform=linux\artifacts\csharp_ext_* nativelibs\
xcopy /Y /I /S ..\..\platform=macos\artifacts\csharp_ext_* nativelibs\

@rem Collect protoc artifacts built by the previous build step
xcopy /Y /I /S ..\..\platform=windows\artifacts\protoc_* protoc_plugins\
xcopy /Y /I /S ..\..\platform=linux\artifacts\protoc_* protoc_plugins\
xcopy /Y /I /S ..\..\platform=macos\artifacts\protoc_* protoc_plugins\
